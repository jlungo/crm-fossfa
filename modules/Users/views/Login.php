	...
	function process (Vtiger_Request $request) {
		...
		if ($error) {
			switch ($error) {
				...
				case 'register'	:	$message = 'User already Exist';	break;
			        case 'checkmail'	:	$message = 'Mail has been sent to your inbox, please check your e-mail';	break;
			}
		} else if ($mailStatus) {
			$message = 'Mail has been sent to your inbox, please check your e-mail';
		}
                global $site_URL;
                $register = $site_URL.'index.php?module=Users&view=Register';
                $viewer->assign('REGISTER',$register);
